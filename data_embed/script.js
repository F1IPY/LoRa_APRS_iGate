...
function loadSettings(settings) {
    ...
    document.getElementById("led.wifiActivity").checked                = settings.led ? settings.led.wifiActivity : true;
    document.getElementById("led.loraActivity").checked                = settings.led ? settings.led.loraActivity : true;
    ...
    if (settings.tnc) {
        ...
        document.getElementById("tnc.rnsActive").checked                = settings.tnc.rnsActive;
        document.getElementById("tnc.rnsPort").value                    = settings.tnc.rnsPort != null ? settings.tnc.rnsPort : 8002;
        document.getElementById("tnc.rnsDebug").checked                 = settings.tnc.rnsDebug;
    }
