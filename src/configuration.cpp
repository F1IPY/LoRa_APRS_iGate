...
bool Configuration::writeFile() {
    ...
    try {
        ...
        data["led"]["wifiActivity"]                 = leds.wifiActivity;
        data["led"]["loraActivity"]                 = leds.loraActivity;
        ...
        data["tnc"]["rnsActive"]                    = tnc.rnsActive;
        data["tnc"]["rnsPort"]                      = tnc.rnsPort;
        data["tnc"]["rnsDebug"]                     = tnc.rnsDebug;
...
bool Configuration::readFile() {
    ...
    if (configFile) {
        ...
        if (data["led"]["wifiActivity"].isNull() ||
            data["led"]["loraActivity"].isNull()) needsRewrite = true;
        leds.wifiActivity                = data["led"]["wifiActivity"] | true;
        leds.loraActivity                = data["led"]["loraActivity"] | true;
        ...
        if (data["tnc"]["enableServer"].isNull() ||
            ...
            data["tnc"]["rnsActive"].isNull() ||
            data["tnc"]["rnsPort"].isNull() ||
            data["tnc"]["rnsDebug"].isNull()) needsRewrite = true;
        tnc.enableServer                = data["tnc"]["enableServer"] | false;
        tnc.enableSerial                = data["tnc"]["enableSerial"] | false;
        tnc.acceptOwn                   = data["tnc"]["acceptOwn"] | false;
        tnc.aprsBridgeActive            = data["tnc"]["aprsBridgeActive"] | false;
        tnc.rnsActive                   = data["tnc"]["rnsActive"] | false;
        tnc.rnsPort                     = data["tnc"]["rnsPort"] | 8002;
        tnc.rnsDebug                    = data["tnc"]["rnsDebug"] | false;
...
void Configuration::setDefaultValues() {
    ...
    leds.wifiActivity               = true;
    leds.loraActivity               = true;
